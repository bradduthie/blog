...
The above code stores a vector of ten numbers, shown below.
    ...
    ##  [1]  0.44621326  0.82801855  1.58202480  0.13313198 -0.07899075
    ##  [6] -0.27254839 -0.95780298  0.06515380 -1.90107621  0.45799649
...
The above code stores a vector of ten numbers, shown below.
    ...
    ##  [1] 0.31393356 0.08440500 0.05764135 0.07960940 0.82335910 0.15443877
    ##  [7] 0.41392250 0.88309724 0.57154361 0.33788155
...
The above now shows a random collection of rows, including 70, 304, 145, 322, 375, 46, 522, 6, 528, 120.
...
```
    ...
    ## [1] "Ferrari Dino" "Mazda RX4"

With this procedure, we have therefore sampled Ferrari Dino and Mazda RX4. There are even more types of structures `x` that can be sampled with `sample`, but for now I will move on to using `sample` for statistical hypothesis sampling.
...
This results in an estimated mean total bird length of 159.5441176 with a lower 95% confidence interval of 158.974526 and an upper 95% confidence interval of 160.1137093. We can compare this with 95% confidence intervals calculated in the standard way using standard errors from the song sparrow data set as follows.
