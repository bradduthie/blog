...
The above code stores a vector of ten numbers, shown below.
    ...
    ##  [1]  0.2383358  0.4672784  1.1340229  0.3207790 -0.6198568 -1.0817465
    ##  [7]  1.6719394 -0.9985682  0.6245402  0.4668143
...
The above code stores a vector of ten numbers, shown below.
    ...
    ##  [1] 0.8249559 0.2526507 0.3118720 0.2159534 0.4731284 0.3809387 0.7815236
    ##  [8] 0.7313558 0.8685632 0.6916857
...
The above now shows a random collection of rows, including 291, 359, 146, 85, 98, 254, 577, 427, 533, 268.
...
``` 
    ...
    ## [1] "Toyota Corolla" "Duster 360"

With this procedure, we have therefore sampled Toyota Corolla and Duster 360. There are even more types of structures `x` that can be sampled with `sample`, but for now I will move on to using `sample` for statistical hypothesis sampling.
...
We can plot the latitude and longitude of each of the 59 trees below. The brown box shows the study plot at the field site, randomly set<sup>[2](#foot2)</sup> from latitude 28.289 to 28.2918 and longitude -113.1145 to -113.1095.
