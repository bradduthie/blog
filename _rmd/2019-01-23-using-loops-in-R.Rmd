...
To get <script type="math/tex; mode=display">T_{Celsius}</script>, it is not actually necessary to use a for loop in R; this can be done in one line of code:
...
3. Using a `while` loop, calculate the sum of the series, <script type="math/tex; mode=display">Y = \frac{4}{1} - \frac{4}{3} + \frac{4}{5} - \frac{4}{7} + \frac{4}{9} - \frac{4}{11} + \dots</script> to at least 10000 terms. What does the value <script type="math/tex; mode=display">Y</script> appear to approach as more terms are added? (*Hint: Use `if(){}`, or an `if(){}else{}` to switch from `+` to `-`*)
