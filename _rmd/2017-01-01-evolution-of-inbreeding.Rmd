...
plot(x=rs,y=dl,type="l",lwd=2,
  xlab=expression(paste("Relatedness to potential mate (",italic(r),")")),
  ylab=expression(paste("Inbreeding depression threshold (",italic(delta),")")),
